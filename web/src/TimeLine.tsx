...
export default function TimeLine({timeSpan, progress, textVis, timeLineSpans}: {timeSpan: number[], progress: number | undefined, textVis: boolean, timeLineSpans: number[][]}) {
